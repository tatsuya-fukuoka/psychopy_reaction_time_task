...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\uytat\\OneDrive\\デスクトップ\\psycopy\\test1_lastrun.py',
...
sound_1 = sound.Sound('1100', secs=0.5, stereo=True, hamming=True,
    name='sound_1')
...
polygon_2 = visual.ShapeStim(
    ...
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=0.0, interpolate=True)
sound_2 = sound.Sound('1100', secs=0.5, stereo=True, hamming=True,
    name='sound_2')
...
polygon_4 = visual.ShapeStim(
    ...
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=None, depth=0.0, interpolate=True)
sound_3 = sound.Sound('1100', secs=0.5, stereo=True, hamming=True,
    name='sound_3')
...
for thisTrial in trials:
    ...
    # update component parameters for each repeat
    sound_1.setSound('1100', secs=0.5, hamming=True)
    sound_1.setVolume(1.0, log=False)
    key_resp_target.keys = []
    key_resp_target.rt = []
    _key_resp_target_allKeys = []
    # keep track of which components have finished
    trial1Components = [polygon, sound_1, polygon_target, key_resp_target]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if polygon_target.status == NOT_STARTED and tThisFlip >= 3.5-frameTolerance:
            # keep track of start time/frame for later
        ...
        waitOnFlip = False
        if key_resp_target.status == NOT_STARTED and tThisFlip >= 3.5-frameTolerance:
            # keep track of start time/frame for later
    ...
    # update component parameters for each repeat
    sound_2.setSound('1100', secs=0.5, hamming=True)
    sound_2.setVolume(1.0, log=False)
    key_resp.keys = []
    key_resp.rt = []
    _key_resp_allKeys = []
    # keep track of which components have finished
    trial2Components = [polygon_2, sound_2, polygon_3, key_resp]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # start/stop sound_2
        if sound_2.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
            # keep track of start time/frame for later
        ...
        # *polygon_3* updates
        if polygon_3.status == NOT_STARTED and tThisFlip >= 4.5-frameTolerance:
            # keep track of start time/frame for later
        ...
        # *key_resp* updates
        waitOnFlip = False
        if key_resp.status == NOT_STARTED and tThisFlip >= 4.5-frameTolerance:
            # keep track of start time/frame for later
    ...
    # update component parameters for each repeat
    sound_3.setSound('1100', secs=0.5, hamming=True)
    sound_3.setVolume(1.0, log=False)
    key_resp_2.keys = []
    key_resp_2.rt = []
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    trial3Components = [polygon_4, sound_3, polygon_5, key_resp_2]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *polygon_4* updates
        if polygon_4.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
            # keep track of start time/frame for later
        ...
        # start/stop sound_3
        if sound_3.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
            # keep track of start time/frame for later
        ...
        # *polygon_5* updates
        if polygon_5.status == NOT_STARTED and tThisFlip >= 4.0-frameTolerance:
            # keep track of start time/frame for later
        ...
        # *key_resp_2* updates
        waitOnFlip = False
        if key_resp_2.status == NOT_STARTED and tThisFlip >= 4.0-frameTolerance:
            # keep track of start time/frame for later
